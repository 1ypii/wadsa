...
game.StarterGui:SetCore("SendNotification", {
    Title = "1yyz in discord";
    Text = "This is for zero hood game only.";
...
--Made By 1yyz, reworked by 1yyz, friend helped on orbit thx

--Heavily pasted btw jk

local Library = loadstring(game:HttpGet("https://pastebin.com/raw/kpLzpNXc"))()

local Window = Library:CreateWindow("1yyz Gui", Vector2.new(300, 300), Enum.KeyCode.RightShift)
local AkaliNotif =
